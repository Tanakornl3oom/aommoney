...
<!--			<div id="overlay"></div>-->
            <?php
                ...
                $strSQL = "SELECT * FROM history,saving WHERE history.Hdays = saving.SDays and saving.SUser = '".$_SESSION["user"]."' ";
                $objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
                
                $strSQL1 = "SELECT * FROM history,save_to_buy WHERE history.Hdays = save_to_buy.SBDays and save_to_buy.SBUser = '".$_SESSION["user"]."' ";
